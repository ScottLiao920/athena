...
def generate_single(sess, x, y, attacker=ATTACK.FGSM,
                    candidates=None,
                    attack_count=None,
                    max_perturb=0.1, # get_perturb_upperbound(),
...
def main():
    DATA.set_current_dataset_name(DATA.mnist)
    # gen_greedy(dataset=DATA.CUR_DATASET_NAME, attacker=ATTACK.PGD)
